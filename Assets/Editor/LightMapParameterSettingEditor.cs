       ...
       // return;
        ...
        foreach (var mr in mrs)
        {
            ...
            foreach (var m in mats)
            {
                ...
                if (m.HasProperty("_BakedMap")|| m.HasProperty("_BakedMap")!=null)
                {
                ...
                if (m.HasProperty("_lightmapDir"))
                {
                    Texture2D dirMap = LightmapSettings.lightmaps[mr.lightmapIndex].lightmapDir;
                    m.SetTexture("_lightmapDir", dirMap);
                }
